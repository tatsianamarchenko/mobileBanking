//
//  ButtomPresentationInfoboxViewController.swift
//  FourthProject
//
...
class ButtomPresentationInfoboxViewController: UIViewController {

	public var complition: (([InfoBox]) -> Void)?
	...
	init(adressOfATM: String, infobox: InfoBox, timeOfWork: String, currancy: String, cashIn: String) {
	...
	@objc func openFullInfoVC() {
		let detailNavController = FullInformationViewController(atm: nil, branch: nil, infobox: infobox)
